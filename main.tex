...
\begin{abstract}
Typological universals keep dissolving because we conflate what we compare with how languages realize it. We count articles and call it definiteness. We track nominative case and call it subjecthood. When English nouns or Hebrew subjects are projected directly onto purportedly universal categories, measurement error and spurious asymmetries accumulate. The pattern suggests a fundamental question: which comparative concepts, if any, actually stabilize across unrelated languages through convergent mechanisms, and which are merely inherited templates from familiar languages?

I propose a mechanistic, testable account of why some comparative concepts stabilize across unrelated languages while others dissolve—turning descriptive convenience into a falsifiable hypothesis about convergent evolution. Unlike purely instrumental comparative concepts, some comparanda earn \emph{naturalized} status as homeostatic property cluster kinds when independent cognitive, discourse, diachronic, or community mechanisms converge to maintain their property clusters. Naturalization requires three components: a \emph{comparanda--realization} mapping that separates cross-linguistic functions and targets from language-specific realizations; a \emph{syntax--semantics firewall} that tests semantic targets independently of morphosyntactic form; and \emph{measurement discipline} that promotes concepts to naturalized status only when they meet empirical thresholds for cross-linguistic clustering, mechanistic explanation, and predictive purchase.
