...
% Firewall annotation - positioned between steps 2 and 3
\draw[dashed, red, ultra thick] ([xshift=-2.5cm,yshift=-0.75cm]step2.south west) -- ([xshift=2.5cm,yshift=-0.75cm]step2.south east);
\node[right=0.5cm of step2.south east, yshift=-0.75cm, text=red, font=\bfseries] {FIREWALL};
